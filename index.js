...
var ASM_CONSTS = {
 ...
 169368: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 169451: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 169520: () => { return window.innerWidth; },  
 169550: () => { return window.innerHeight; }
};

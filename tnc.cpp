...
// Tworzenie programu shaderowego z uproszczoną logiką
GLuint CreateShaderProgram() {
    ...
    // Uproszczony Fragment Shader, który rysuje na zielono
    const char* fragmentSrc = R"(
        precision mediump float;
        void main() {
            gl_FragColor = vec4(0.0, 1.0, 0.0, 1.0); // Rysuj na zielono
        }
    )";
...
void main_loop() {
    ...
    glClearColor(1.0f, 0.0f, 0.0f, 1.0f); // Tło na czerwono
    ...
    // Zastosujmy skalowanie i obrót na macierz modelu
...
int main() {
    ...
    std::cout << "uniformModel location: " << uniformModelLoc << std::endl;
    std::cout << "uniformTexture location: " << uniformTextureLoc << std::endl;
